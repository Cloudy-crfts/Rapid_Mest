...
class Message {
  final int? id;
  final String? messageId;         // Wire-level id (unique across devices)
  final String deviceId;           // Foreign key to Device
  final int messageType;           // See MessageType
  ...
  final int status;                // See MessageStatus
  ...
  bool get isTextOnly => messageType == MessageType.text && !hasAttachment;
