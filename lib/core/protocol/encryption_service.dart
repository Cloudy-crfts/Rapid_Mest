...
class EncryptionService {
  ...
  Future<void> _restoreKeyPair(String privateKeyHex) async {
    try {
      // Parse and restore private key from its hex encoding
      final seed = _hexToBytes(privateKeyHex);
  ...
  String exportPublicKey() {
    if (_publicKey == null) throw Exception('Not initialized');
    
    // Export as base64 or hex string for transmission
    final publicKeyBytes = _publicKey!.bytes;
    return _bytesToHex(Uint8List.fromList(publicKeyBytes));
  }
