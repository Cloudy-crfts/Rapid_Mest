...
class PacketHeader {
  ...
  final int packetType;     // See PacketType
...
class Packets {
  ...
  static Packet createHandshakeResponse({
    ...
    return Packet(
      header: PacketHeader(
        packetType: PacketType.handshakeResponse,
        payloadLength: payload.length,
        sequenceNumber: 0,
      ),
      payload: Uint8List.fromList(payload),
  ...
  static Packet createMessageAck({
    ...
    return Packet(
      header: PacketHeader(
        packetType: PacketType.messageAck,
        payloadLength: payload.length,
  ...
  static Packet createFileResponse({
    ...
    return Packet(
      header: PacketHeader(
        packetType: PacketType.fileResponse,
        payloadLength: payload.length,
        sequenceNumber: 0,
      ),
      payload: Uint8List.fromList(payload),
  ...
  static Packet createFileChunkAck({
    ...
    return Packet(
      header: PacketHeader(
        packetType: PacketType.fileChunkAck,
        payloadLength: payload.length,
