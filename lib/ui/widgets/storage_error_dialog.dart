...
class StorageErrorDialog extends StatelessWidget {
          ...
          children: [
            ...
            if (requiredSpace != null && availableSpace != null) ...[
              ...
              Container(
                ...
                child: Column(
                  children: [
                    _buildSpaceRow(context, 'Needed', requiredSpace!, AppTheme.error),
                    const SizedBox(height: 8),
                    _buildSpaceRow(context, 'Available', availableSpace!, AppTheme.warning),
                    const SizedBox(height: 8),
  ...
  Widget _buildSpaceRow(BuildContext context, String label, int bytes, Color color, {bool isBold = false}) {
    return Row(
